                    ...
                    if "normal" in textures:
                        ...
                        try:
                            if bump_node.parm("inputMapType") is not None:
                                bump_node.parm("inputMapType").set(1)  # 1 = Tangent-Space Normal
                        except:
                            pass
    ...
    def create_materials(self):
        ...
        if using_checkboxes:
            ...
            if not materials_to_create:
                QtWidgets.QMessageBox.warning(
                    self, "No Selection", "No materials selected. Please select at least one material.")
                return
        else:
            ...
            materials_to_create = [item.data(QtCore.Qt.UserRole) for item in material_items]
